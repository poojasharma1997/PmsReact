      ...
      >
           <div className="row gy-4">
            <div className="col-12 pt-3">
              <div className="mainHeading px-3">Add  Room</div>
            </div>
                  ...
                  <div className="col-12">
                    <div className="sectionContentHeader py-3 px-4 mb-4 rounded-3">
                      <div className="row d-flex align-items-center">
                        <div className="col">
                          <div className="sectionHeaderHeaing">Add New Room</div>
                        </div>
                      </div>
                    </div>
                  </div>
                              ...
                              <div className="row gy-3">
                                ...
                                <div className="col-md-12">
                                  ...
                                  >
                                    ...
                                    <option value="1">Executive Ruby</option>
                                ...
                                <div className="col-md-12">
                                  ...
                                  >
                                    ...
                                    <option value="1">Double Size</option>
                                ...
                                <div className="col-md-12">
                                  ...
                                  >
                                    ...
                                    <option value="1">Seasonal Size</option>
                                    <option value="1">Holiday Bed</option>
