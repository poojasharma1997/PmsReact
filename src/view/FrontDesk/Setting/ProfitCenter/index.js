...
function ProfitCenter() {
  const columns = [
    {
      name: "ProfitCenterLocation	",
      selector: (row) => row.profitCenterLocation,
    },
    {
      name: "ProfitCenterBalance	",
      selector: (row) => row.profitCenterBalance,
    },
    {
      name: "Status",
      cell: (row) => (
  ...
  const data = [
    {
      id: 1,
      profitCenterLocation: "Chennai	",
      profitCenterBalance: "0.00",
    },
    {
      id: 2,
      profitCenterLocation: "Bengaluru	",
      profitCenterBalance: "0.00	",
    },
  ];
      ...
      <div className="section">
        <div className="row gy-4">
          <div className="col-12 pt-3">
            <div className="mainHeading px-3">Profit Center List</div>
          </div>
                ...
                <div className="col-12">
                  <div className="sectionContentHeader py-2 px-4 mb-4 rounded-3">
                    <div className="row d-flex align-items-center">
                      <div className="col">
                        <div className="sectionHeaderHeaing">Profit Center</div>
                      </div>
                      ...
                      <div className="col-auto">
                        ...
                        >
                          ...
                          <div className="categoryText">Add Profit Center</div>
                        </Link>
                      </div>
                    </div>
                  </div>
