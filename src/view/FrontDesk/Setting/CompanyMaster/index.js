  ...
  const data = [
    {
      ...
      address: "Shady Grove Rd Rockville",
      email:"abcint@gmail.com",
      phonenumber:"+1-240-383-8019",
      contactperson:"James Carry",
      action: "",
    ...
    {
        id: 3,
        companyname:"Hotel Dummy",
        address: "Shady Grove Rd Rockville",
        email:"dummy321@gmail.com",
        phonenumber:"+1-240-383-8019",
        contactperson:"Jim Ross",
        action: "",
      ...
      <div className="section">
        <div className="row gy-4">
          <div className="col-12 pt-3">
            <div className="mainHeading  px-3">Company List</div>
          </div>
                    ...
                    <div className="row d-flex align-items-center">
                      ...
                      <div className="col-auto">
                        ...
                        >
                          ...
                          <div className="categoryText">Add Company</div> 
                         </Link>
                      </div>
                    </div>
                  </div>
