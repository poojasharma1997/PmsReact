...
function NatureOfVisit() {
  const columns = [
    {
      name: "NatureOfVisit",
      selector: (row) => row.natureOfVisit,
    },
    {
      name: "Date",
  ...
  const data = [
    {
      id: 1,
      natureOfVisit: "Business	",
      date: "01/01/2022",
    },
    {
      id: 2,
      natureOfVisit: "Religious Purpose	",
      date: "01/01/2022	",
    },
  ];
      ...
      <div className="section">
        <div className="row gy-4">
          <div className="col-12 pt-3">
            <div className="mainHeading px-3">Nature Of Visit</div>
          </div>
