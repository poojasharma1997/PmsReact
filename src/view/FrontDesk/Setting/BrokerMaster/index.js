...
function BrokerMaster() {
  const columns = [
    ...
    {
        name: "Broker/OTA Type",
        selector: (row) => row.brokertype,
      },
      {
        name: "Broker/OTA Name ",
        selector: (row) => row.brokername,
      },

    {
        name: "Commission Type",
        selector: (row) => row.commissiontype,
      },
      {
        name: "Commission",
      ...
      {
        name: "Commission Applied for",
        selector: (row) => row.commissionappliedfor,
      },
  ...
  const data = [
    {
      id: 1,
      brokerid:"TAG006",
      brokertype: "Travel Agent",
      brokername:"John Doe",
      commissiontype:"Percentage",
      commission:"5%",
      commissionappliedfor:"Room Rent",
      action: "",
    ...
    },
    {
      ...
      commission:"₹700.00",
      commissionappliedfor:"Total Billing",
      action: "",
    ...
    },
    {
        ...
        commissiontype:"Percentage",
        commission:"7%",
        commissionappliedfor:"Room Rent + Food",
        action: "",
      ...
      <div className="section">
        <div className="row gy-4">
          <div className="col-12 pt-3">
            <div className="mainHeading  px-3">Brokertype List</div>
          </div>
                    ...
                    <div className="row d-flex align-items-center">
                      ...
                      <div className="col-auto">
                        ...
                        >
                          ...
                          <div className="categoryText">Add Broker/OTA</div> 
                         </Link>
                      </div>
                    </div>
                  </div>
