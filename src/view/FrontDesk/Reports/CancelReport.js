  ...
  const data = [
    {
      ...
      paidamount: "1500.00",
      refund: "1000.00",
      cancelreason: "lorem ipsum dolor sir amet",
    },
    {
      id: 2,
      season: "Mid",
      ...
      <div className="section">
        <div className="row gy-4">
          <div className="col-12 pt-3">
            <div className="mainHeading  px-3">Cancel Report</div>
          </div>
                ...
                <div className="col-12">
                  <div className="sectionContentHeader py-2 px-4 mb-4 rounded-3">
                    <div className="row d-flex align-items-center">
                      <div className="col">
                        <div className="sectionHeaderHeaing">Cancel Report</div>
                      </div>
                      {/* <div className="col-auto">
                        <Link
                          to=""
