...
function OccupancyReport() {
  const columns = [
...

    {
      ...
      selector: (row) => row.totalnoofrooms,
    },
    {
      name: "Total Occupied Room",
      selector: (row) => row.totaloccupiedroom,
    },
    {
      name: "Total Available Room",
      selector: (row) => row.totalavailableroom,
    },
    {
      name: "Occupancy%",
  ...
  const data = [
    {
      ...
      totaloccupiedroom: "1 Unit	",
      totalavailableroom: "24",
      occupancy: "4.00%	",
    },
    {
      id: 2,
      ...
      <div className="section">
        <div className="row gy-4">
          <div className="col-12 pt-3">
            <div className="mainHeading  px-3">Occupancy Report</div>
          </div>
