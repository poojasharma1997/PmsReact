...
function DailyReservationSummary() {
  const columns = [
    {
      name: "Sr. No",
  ...
  const data = [
    {
      id: 1,
      srno: "1",
      dates: "Thursday 4th August 2022",
      unitsbooked: "1 Unit|4.00%|-(1/0)",
      roomrent: "2000.00",
      rrtax: "240.00",
      mealplan: "0.00",
      mptax: "0.00",
      ...
      <div className="section">
        <div className="row gy-4">
          <div className="col-12 pt-3">
            <div className="mainHeading  px-3">Daily Reservation Summary</div>
          </div>
...
export default DailyReservationSummary;
