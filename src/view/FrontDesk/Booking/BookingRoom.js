      ...
      <div className="section">
        <div className="row gy-4">
          <div className="col-12 pt-3">
            <div className="mainHeading px-3">Booking Room</div>
          </div>
                ...
                <div className="col-12">
                  <div className="sectionContentHeader py-3 px-4 mb-4 rounded-3">
                    <div className="row d-flex align-items-center">
                      <div className="col">
                        <div className="sectionHeaderHeaing">Booking Room</div>
                      </div>
                    </div>
                  </div>
                </div>
                                  ...
                                  <Col md={3}>
                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        <MenuItem value={20}>101</MenuItem>
                                        <MenuItem value={30}>102</MenuItem>
                                        <MenuItem value={40}>103</MenuItem>
                                      </Select>
                                    </FormControl>
                                  </Col>
                                  <Col md={3}>
          ...
          views={['year', 'month', 'day']}/>
                        ...
                        <Col md={12}>
                          <div className="FormInner pt-3 pb-5">
                            <Row className="gy-3">
                              <Col md={12} className="">
                                <div className="pb-2 InnerHeading text-center">
                                  Billing Information
          ...
          views={['year', 'month', 'day']}/>
                                  ...
                                  <Col md={12}>
                                    <Row className="gy-4">
                                      <Col md={2}>
                                        <div className="Label">Room Rent :</div>
                                      </Col>
                                      <Col md={2}>
                                        <div className="Label">
                                          Exbed (RR) :
