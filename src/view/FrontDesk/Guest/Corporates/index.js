  ...
  const data = [
    {
      ...
      state: "MD",
      country: "USA",
      incorporationtype: "Limited",
      industrytype: "IT",
      fieldofwork: "Software",
      noofemployees: "33",
      noofbranches: "4",
      gstno: "18AABCU9603R1ZM",
      cinno: "L01631KA2010PTC09684",
      rating: "4",
      action: "",
    },
  ];
      ...
      <div className="section">
        <div className="row gy-4">
          <div className="col-12 pt-3">
            <div className="mainHeading  px-3">Corporates</div>
          </div>
                ...
                <div className="col-12">
                  <div className="sectionContentHeader py-2 px-4 mb-4 rounded-3">
                    <div className="row d-flex align-items-center">
                      <div className="col">
                        <div className="sectionHeaderHeaing">All Corporate</div>
                      </div>
                      <div className="col-auto">
                        <Link
                          to="/addCorporate"
                        ...
                        >
                          ...
                          <div className="categoryText">Add Corporate</div>
                        </Link>
                      </div>
                    </div>
                  </div>
