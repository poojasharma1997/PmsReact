                ...
                <div className="section">
                    <div className="row gy-4">
                        <div className="col-12 pt-3">
                            <div className="mainHeading px-3">Add Discount</div>
                        </div>
                                                ...
                                                <div className="row gy-3">
                                                            ...
                                                            <div className="row gy-3">
                                                                <div className="col-md-12">
                                                                    <Form.Group className="mb-3" controlId="formBasicPassword">
                                                                        <Form.Control className='shadow-none' type="password" placeholder="Full Name" />
                                                                    </Form.Group>
                                                                   
                                                                </div>
                                                                <div className="col-md-12">
                                                                    <Form.Group className="mb-3" controlId="formBasicPassword">
                                                                        <Form.Control className='shadow-none' type="password" placeholder="Discount End Percentage" />
                                                                    </Form.Group>
                                                                ...
                                                                <div className="col-md-12">
                                                                    <Form.Select aria-label="Default select example" className="shadow-none mb-3">
                                                                        ...
                                                                        <option value="1">All Guest</option>
                                                                        <option value="2">All Family</option>
                                                                        <option value="3">All Bachelor</option>
                                                                        <option value="3">Corporate</option>
                                                                        <option value="3">All Sr. Citizen</option>
                                                                        <option value="3">Military</option>
                                                                        <option value="3">Retired Military</option>
                                                                        <option value="3">All Tourist</option>
                                                                        <option value="3">VIP</option>
                                                                        <option value="3">Internal Staff</option>
                                                                        <option value="3">All Woman</option>
                                                                        <option value="3">Backpackers</option>
                                                                        <option value="3">Nomadics</option>
                                                                        <option value="3">Bikers</option>
                                                                    </Form.Select>
                                                                </div>
                                                                <div className="col-md-12">
                                                                    <Form.Select aria-label="Default select example" className="shadow-none mb-3">
                                                                        <option>Discount Applicable for Food Charges Only</option>
                                                    ...
                                                    <div className="col-md-6">
                                                        ...
                                                        <div className="row gy-3">
                                                                <div className="col-md-12">
                                                                    <Form.Group className="mb-3" controlId="formBasicPassword">
                                                                        <Form.Control className='shadow-none' text="multiline" type="password" placeholder="Discount Start Percentage" />
                                                                    </Form.Group>
                                                                   
                                                                </div>
                                                                <div className="col-md-12">
                                                                    <Form.Group className="mb-3" controlId="formBasicPassword">
                                                                        <Form.Control className='shadow-none' type="password" placeholder="Discount" />
                                                                    </Form.Group>
                                                                   
                                                                </div>
                                                                <div className="col-md-12">
                                                                    <Form.Select aria-label="Default select example" className="shadow-none mb-3">
                                                                        <option>Discount Applicable for Room Rent Only</option>
                                                                        <option value="1">Yes</option>
                                                                        <option value="2">No</option>
                                                                    </Form.Select>
                                                                </div>
