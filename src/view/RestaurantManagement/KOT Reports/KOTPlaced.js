                ...
                <div className="section">
                    <div className="row gy-4">
                        <div className="col-12 pt-3">
                            <div className="mainHeading px-3">KOT Placed</div>
                        </div>
                                                        ...
                                                        <div className="make-box">
                                                            <div className="row">
                                                                <p>
                                                                    ...
                                                                    Order Status:   <span class="badge bg-primary">Order Placed</span> <br />
                                                            ...
                                                            <div className="row">
                                                                ...
                                                                <button type="submit" class="btn btn-danger new-btn">CANCEL ORDER</button>
                                                                <button type="submit" class="btn btn-warning new-btn">ORDER AGAIN</button>
                                                                <button type="submit" class="btn btn-success new-btn">ORDER CONFIRM</button>
                                                        ...
                                                        <div className="make-box">
                                                            <div className="row">
                                                                <p>
                                                                    Order No.:  #SM/POS/2022/12230 <br />
                                                                    Placed at:  09-09-2022 12:49 <br />
                                                                    Order Status:  <span class="badge bg-primary">Order Confirmed</span> <br />
                                                                    Customer:  Walk-in Customer <br />
                                                                    Ordered By:  Waiter <br />
                                                                    Table No.:  S10 <br />
                                                                    Room No.:  N/A <br />
                                                            ...
                                                            <div className="row">
                                                                <button type="submit" class="btn btn-primary new-btn">ORDER DETAILS</button>
                                                                <button type="submit" class="btn btn-success new-btn">GENERATE BILL</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div className="make-box">
                                                            <div className="row">
                                                                <p>
                                                                    Order No.:  #SM/POS/2022/12230 <br />
                                                                    Placed at:  09-09-2022 12:49 <br />
                                                                    Order Status:   <span class="badge bg-success">Order Delivered</span> <br />
                                                                    Customer:  Walk-in Customer <br />
                                                                    Ordered By:  Waiter <br />
                                                                    Table No.:  S10 <br />
                                                                    Room No.:  N/A <br />
